(function () {
    ...
    Colorpicker.prototype = {
        init(opt) {
            ...
            this.elem_btnClose = div.getElementsByClassName("btn-close-colorpicker")[0];
            ...
            this.elem_btnClose.addEventListener("click", function (e) {
                _this.hide();
            },false)
        ...
        render: function () {
            var tpl =
				...
				<div style="position: relative;z-index: 100;display: flex;box-shadow: rgba(0, 0, 0, 0.3) 0px 0px 2px, rgba(0, 0, 0, 0.3) 0px 4px 8px;">
                    <a class="btn-close-colorpicker" style="position:absolute;z-index:1;right:0px;bottom:0px;display:block;padding:3px 6px;font-size:14px;border-radius:8px 0 0 0;background-color:#f0f1f5">关闭</a>
        ...
        setPosition(x, y) {
            ...
            var eleRect = this.elem_wrap.getBoundingClientRect();
            var LEFT = parseInt(x - this.elem_colorPalette.clientWidth - eleRect.left - document.documentElement.scrollLeft),
                TOP = parseInt(y -  eleRect.top - document.documentElement.scrollTop);
        ...
        show: function () {
            var eleRect = this.bindElem.getBoundingClientRect();
            util.css(this.elem_wrap, {
                "display": "block",
                "left": (eleRect.left + document.documentElement.scrollLeft) + "px",
                "top": (eleRect.top + eleRect.height + document.documentElement.scrollTop) + "px"
            })
        },
        hide: function () {
            util.css(this.elem_wrap, {
