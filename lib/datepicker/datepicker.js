        ...
        bindEvent: function(type) {
            ...
            function setTimeGearTooth() {
                ...
                if (time_hh && time_hh.getAttribute("val")) {
                    ...
                    time_hh.innerHTML = i;
                    time_hh.style["transform"] = 'translate3d(0,' + (8 - hhVal * 2) + 'em,0)';
                ...
                if (time_mm && time_mm.getAttribute("val")) {
                    ...
                    time_mm.innerHTML = i;
                    time_mm.style["transform"] = 'translate3d(0,' + (8 - mmVal * 2) + 'em,0)';
