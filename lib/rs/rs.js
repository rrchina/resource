!(function ($) {
    ...
    function Cascade(option) {
        ...
        for (var i = 0; i < this.settings.data.length; i++) {
            ...
            firstList.append('<div class="list-item" data-level="0" data-id="'+dataitem.id+'" data-text="'+(dataitem.text||dataitem.name)+'">'+(dataitem.text||dataitem.name)+'</div>')
        }
            ...
            if (level < that.settings.labels.length - 1) {
                ...
                if (clickedDataItem && clickedDataItem.children) {
                    ...
                    for (var i = 0; i < clickedDataItem.children.length; i++) {
                        ...
                        $nextList.append('<div class="list-item" data-level="' + nextLevel + '" data-id="' + dataitem.id + '" data-text="' +(dataitem.text||dataitem.name) + '">' + (dataitem.text||dataitem.name) + '</div>')
                    }
                    //激活下一级
